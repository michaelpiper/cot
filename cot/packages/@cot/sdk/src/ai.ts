...
export class AI {
    ...
    predictAPI = async (prompt: string) => {
    ...
    callQwenAPI = async (userInput: string, sessionId: string) => {
                ...
                },
                {
                    headers: {
                        accept:
                            "*/*",
                        authorization:
                            "Bearer VC/X3qHg/LxAgtZ+E2aXyiqUcpA0kIA1+gseJbWwBLKfS6ljAROcvXFrctmZjouX",
                        "content-type":
                            "application/json",
                        ...
                        "sec-ch-ua-full-version-list":
                            `"Chromium";v="134.0.6998.89", "Not:A-Brand";v="24.0.0.0", "Google Chrome";v="134.0.6998.89"`,
                        "sec-ch-ua-mobile":
                            "?0",
                        "sec-ch-ua-model":
                            `""`,
                        ...
                        "x-client-version":
                            '1.0.0-always',
                        "x-ds-pow-response":
                            ""
                    }
                })
            return response.data;
        } catch (error) {
